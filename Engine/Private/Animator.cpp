...
void CAnimator::Interpolate_Animation(_float fTimeDelta)
{
	Lock();
	m_pTargetModel->Interpolate_Animation(fTimeDelta);
}
...
_bool CAnimator::Get_InterpolateEnd() const
{
	return m_pTargetModel->Get_CurrentAnim()->Get_InterpolateEnd();
}

_float CAnimator::Get_TrackPosition(_uint iAnimationIndex) const
{
	return m_pTargetModel->Get_Animation(iAnimationIndex)->Get_TrackPosition();
}
...
void CAnimator::Reset_Animation(_uint _iAnimationIndex)
{
