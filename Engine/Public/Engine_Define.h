...
constexpr _uint		g_iMaxBones						= 320;

constexpr _float	g_fGravity						= 9.8f * 6.f;
constexpr _float	g_fDefaultInterpolationDuration	= 0.2f;
constexpr _float	g_fPlayerAnimationSpeed			= 2.5f;
constexpr _float	g_fPlayerSound					= 2.5f;
constexpr XMFLOAT3	g_vGridSize						= XMFLOAT3(50.f, 50.f, 50.f);

constexpr _uint		g_iShadowScale					= 6;
