...
public:
	...
	void						Set_OrthoProjection(const _float4x4& mOrthoProjection)				{ m_mOrthographicProjectionMatrix = mOrthoProjection; }
	const						_float4x4& Get_OrthoProjection()									{ return m_mOrthographicProjectionMatrix; }
...
private:
	_float4x4					m_mOrthographicProjectionMatrix;
