...
#define MOVIE_MAX       238

CUI_Indicator_Tooltip_Tutorial_PMCC::CUI_Indicator_Tooltip_Tutorial_PMCC(ComPtr<ID3D11Device> _pDevice, ComPtr<ID3D11DeviceContext> _pContext)
    : CGameObject(_pDevice, _pContext)
{
}

HRESULT CUI_Indicator_Tooltip_Tutorial_PMCC::Initialize_Prototype()
{
...
HRESULT CUI_Indicator_Tooltip_Tutorial_PMCC::Initialize(any _aDesc)
{
...
void CUI_Indicator_Tooltip_Tutorial_PMCC::Tick(_float fTimeDelta)
{
    __super::Tick(fTimeDelta);
}

void CUI_Indicator_Tooltip_Tutorial_PMCC::Late_Tick(_float fTimeDelta)
{
...
HRESULT CUI_Indicator_Tooltip_Tutorial_PMCC::Render()
{
    if (true == m_bMovieStart)
    {
        ...
        /* Key_W */
        if (FAILED(m_pTexture_Key_W->Bind_ShaderResourceView(m_pShader, aiTextureType_DIFFUSE, "g_texDiffuse")))
        {
            MSG_RETURN(E_FAIL, "CUI_Indicator_Tooltip_Tutorial_PMCC::Render", "Failed to CTexture::Bind_ShaderResourceView");
        }
        if (FAILED(m_pKey_W->Bind_OnShader(m_pShader)))
        {
            MSG_RETURN(E_FAIL, "CUI_Indicator_Tooltip_Tutorial_PMCC::Render", "Failed to CTexture::Bind_OnShader");
        }
        if (FAILED(m_pShader->Bind_RawValue("g_fTime", &m_fMovieShaderTime, sizeof(_float))))
        ...
        /* Key_S */
        if (FAILED(m_pTexture_Key_S->Bind_ShaderResourceView(m_pShader, aiTextureType_DIFFUSE, "g_texDiffuse")))
        {
            MSG_RETURN(E_FAIL, "CUI_Indicator_Tooltip_Tutorial_PMCC::Render", "Failed to CTexture::Bind_ShaderResourceView");
        }
        if (FAILED(m_pKey_S->Bind_OnShader(m_pShader)))
        {
            MSG_RETURN(E_FAIL, "CUI_Indicator_Tooltip_Tutorial_PMCC::Render", "Failed to CTexture::Bind_OnShader");
        }
        if (FAILED(m_pShader->Bind_RawValue("g_fTime", &m_fMovieShaderTime, sizeof(_float))))
        ...
        /* Key_ENTER */
        if (FAILED(m_pTexture_Key_Shift->Bind_ShaderResourceView(m_pShader, aiTextureType_DIFFUSE, "g_texDiffuse")))
        {
            MSG_RETURN(E_FAIL, "CUI_Indicator_Tooltip_Tutorial_PMCC::Render", "Failed to CTexture::Bind_ShaderResourceView");
        }
        if (FAILED(m_pKey_Shift->Bind_OnShader(m_pShader)))
        {
            MSG_RETURN(E_FAIL, "CUI_Indicator_Tooltip_Tutorial_PMCC::Render", "Failed to CTexture::Bind_OnShader");
        }
        if (FAILED(m_pShader->Bind_RawValue("g_fTime", &m_fMovieShaderTime, sizeof(_float))))
        {
            MSG_RETURN(E_FAIL, "CUI_Indicator_Tooltip_Tutorial_PMCC::Render", "Failed to CTexture::Bind_RawValue");
        }
        if (FAILED(__super::Render(65)))
        {
            MSG_RETURN(E_FAIL, "CUI_Indicator_Tooltip_Tutorial_PMCC::Render", "Failed to CGameObject::Render");
        ...
        CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strExplanation1,  _float2(733.f, 530.f),  XMVectorSet(m_fSeperateLineTime, m_fSeperateLineTime, m_fSeperateLineTime, m_fMovieShaderTime), 0.5f);
        CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strExplanation2,  _float2(593.f, 570.f),  XMVectorSet(m_fSeperateLineTime, m_fSeperateLineTime, m_fSeperateLineTime, m_fMovieShaderTime), 0.5f);
        CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strExplanation3,  _float2(631.f, 610.f),  XMVectorSet(m_fSeperateLineTime, m_fSeperateLineTime, m_fSeperateLineTime, m_fMovieShaderTime), 0.5f);
...
HRESULT CUI_Indicator_Tooltip_Tutorial_PMCC::Ready_Components()
{
...
void CUI_Indicator_Tooltip_Tutorial_PMCC::Initialize_UI()
{
//=========================================================================== _float
...
//=========================================================================== Transform
    ...
    m_pKey_W                            = CTransform::Create(m_pDevice, m_pContext);
    m_pKey_A                            = CTransform::Create(m_pDevice, m_pContext);
    m_pKey_S                            = CTransform::Create(m_pDevice, m_pContext);
    m_pKey_D                            = CTransform::Create(m_pDevice, m_pContext);
    m_pKey_Shift                        = CTransform::Create(m_pDevice, m_pContext);
...
//=========================================================================== Texture
    ...
    m_pTexture_Movie                    = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Indicator/Tutorial_Tips/PMCC/T_ui_TutoTips_001_01_common_f_MV_Movie_40534656.mkv_%d.png"), MOVIE_MAX, true);
    ...
    m_pTexture_Key_W                    = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Indicator/Information/KeyBoard/W.png"));
    m_pTexture_Key_A                    = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Indicator/Information/KeyBoard/A.png"));
    m_pTexture_Key_S                    = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Indicator/Information/KeyBoard/S.png"));
    m_pTexture_Key_D                    = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Indicator/Information/KeyBoard/D.png"));
    m_pTexture_Key_Shift                = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Indicator/Information/KeyBoard/Shift_L.png"));
...
//=========================================================================== _float3
    ...
    m_vScale_Key_W                      = _float3(30.f, 30.f, 1.f);
    m_vScale_Key_A                      = _float3(30.f, 30.f, 1.f);
    m_vScale_Key_S                      = _float3(30.f, 30.f, 1.f);
    m_vScale_Key_D                      = _float3(30.f, 30.f, 1.f);
    m_vScale_Key_Shift                  = _float3(30.f, 30.f, 1.f);
...
//=========================================================================== _float4
    ...
    m_vPosition_Key_W                   = _float4(-350.f, 0.f, 0.f, 1.f);
    m_vPosition_Key_A                   = _float4(-315.f, 0.f, 0.f, 1.f);
    m_vPosition_Key_S                   = _float4(-280.f, 0.f, 0.f, 1.f);
    m_vPosition_Key_D                   = _float4(-245.f, 0.f, 0.f, 1.f);
    m_vPosition_Key_Shift               = _float4(-350.f, -80.f, 0.f, 1.f);
...
//=========================================================================== Set_Scale
    ...
    m_pKey_W->Set_Scale(m_vScale_Key_W);
    m_pKey_A->Set_Scale(m_vScale_Key_A);
    m_pKey_S->Set_Scale(m_vScale_Key_S);
    m_pKey_D->Set_Scale(m_vScale_Key_D);
    m_pKey_Shift->Set_Scale(m_vScale_Key_Shift);
...
//=========================================================================== Set_Position
    ...
    m_pKey_W->Set_State(TRANSFORM::POSITION, m_vPosition_Key_W);
    m_pKey_A->Set_State(TRANSFORM::POSITION, m_vPosition_Key_A);
    m_pKey_S->Set_State(TRANSFORM::POSITION, m_vPosition_Key_S);
    m_pKey_D->Set_State(TRANSFORM::POSITION, m_vPosition_Key_D);
    m_pKey_Shift->Set_State(TRANSFORM::POSITION, m_vPosition_Key_Shift);
    m_pKey_ENTER->Set_State(TRANSFORM::POSITION, m_vPosition_Key_ENTER);

//=========================================================================== Explanation
    m_strTitle          = L"이동";
    m_strExplanation1   = L"로 플레이어를 이동.";
    m_strExplanation2   = L"마우스로 카메라 조작.";
    m_strExplanation3   = L"로 플레이어 뛰기가 가능하다.";
    m_strEnter          = L"닫기";

}

void CUI_Indicator_Tooltip_Tutorial_PMCC::Tick_UI(_float fTimeDelta)
{
...
void CUI_Indicator_Tooltip_Tutorial_PMCC::Movie_System(_float fTimeDelta)
{
...
void CUI_Indicator_Tooltip_Tutorial_PMCC::Sound(_float fTimeDelta)
{
    if (true == m_bMovieStart && false == m_bToolTip_End)
    {
        if (0 == m_iSoundIndex)
...
void CUI_Indicator_Tooltip_Tutorial_PMCC::Movie_Start()
{
...
void CUI_Indicator_Tooltip_Tutorial_PMCC::Movie_End(_float fTimeDelta)
{
...
shared_ptr<CUI_Indicator_Tooltip_Tutorial_PMCC> CUI_Indicator_Tooltip_Tutorial_PMCC::Create(ComPtr<ID3D11Device> _pDevice, ComPtr<ID3D11DeviceContext> _pContext)
{
    shared_ptr<CUI_Indicator_Tooltip_Tutorial_PMCC> pInstance = make_private_shared(CUI_Indicator_Tooltip_Tutorial_PMCC, _pDevice, _pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_RETURN(nullptr, "CUI_Indicator_Tooltip_Tutorial_PMCC::Create", "Failed to Initialize_Prototype");
    }

    return pInstance;
}

shared_ptr<CGameObject> CUI_Indicator_Tooltip_Tutorial_PMCC::Clone(any aDesc)
{
    shared_ptr<CUI_Indicator_Tooltip_Tutorial_PMCC> pInstance = make_private_shared_copy(CUI_Indicator_Tooltip_Tutorial_PMCC, *this);
