...
CUI_Menu_Profile_PartySupport2::CUI_Menu_Profile_PartySupport2(ComPtr<ID3D11Device> _pDevice, ComPtr<ID3D11DeviceContext> _pContext)
    : CGameObject(_pDevice, _pContext)
{
}

HRESULT CUI_Menu_Profile_PartySupport2::Initialize_Prototype()
{
...
HRESULT CUI_Menu_Profile_PartySupport2::Initialize(any _pPlayerEntityDesc)
{   
    ...
    m_vPositionOn                   = _float4(-670.f, -321.f, 0.5f, 1.f);
    ...
    m_vPosition_ProfileFrameOn      = _float4(-680.f, -320.f, 0.4f, 1.f);
    m_vPosition_ProfileFrameOff     = _float4(-680.f, -320.f, 0.4f, 1.f);


    /* Profile Index */
    m_vScale_ProfileIndexOn         = _float3(34.f, 34.f, 1.f);
    m_vScale_ProfileIndexOff        = _float3(34.f, 34.f, 1.f);
    m_vPosition_ProfileIndexOn      = _float4(-874.f, -296.f, 0.4f, 1.f);
    m_vPosition_ProfileIndexOff     = _float4(-874.f, -296.f, 0.4f, 1.f);


    /* MEMBER */
    m_vScale_MEMBEROn               = _float3(40.f, 7.f, 1.f);
    m_vScale_MEMBEROff              = _float3(40.f, 7.f, 1.f);
    m_vPosition_MEMBEROn            = _float4(-873.f, -328.f, 0.4f, 1.f);
    m_vPosition_MEMBEROff           = _float4(-873.f, -328.f, 0.4f, 1.f);


    /* Profile */
    m_vScale_ProfileOn              = _float3(85.f, 84.f, 1.f);
    m_vScale_ProfileOff             = _float3(85.f, 84.f, 1.f);
    m_vPosition_ProfileOn           = _float4(-793.f, -318.f, 0.4f, 1.f);
    m_vPosition_ProfileOff          = _float4(-793.f, -318.f, 0.4f, 1.f);


    /* SkillIconFrame */
    m_vScale_SkillIconFrameOn       = _float3(64.f, 64.f, 1.f);
    m_vScale_SkillIconFrameOff      = _float3(64.f, 64.f, 1.f);
    m_vPosition_SkillIconFrameOn    = _float4(-470.f, -298.f, 0.4f, 1.f);
    m_vPosition_SkillIconFrameOff   = _float4(-470.f, -298.f, 0.4f, 1.f);


    /* SkillIcon */
    m_vScale_SkillIconOn            = _float3(52.f, 52.f, 1.f);
    m_vScale_SkillIconOff           = _float3(52.f, 52.f, 1.f);
    m_vPosition_SkillIconOn         = _float4(-470.f, -298.f, 0.4f, 1.f);
    m_vPosition_SkillIconOff        = _float4(-470.f, -298.f, 0.4f, 1.f);


    /* SkillTag */
    m_vScale_SkillTagOn             = _float3(95.f, 20.f, 1.f);
    m_vScale_SkillTagOff            = _float3(95.f, 18.f, 1.f);
    m_vPosition_SkillTagOn          = _float4(-474.f, -355.f, 0.4f, 1.f);
    m_vPosition_SkillTagOff         = _float4(-474.f, -355.f, 0.4f, 1.f);


    /* LoveIcon */
    m_vScale_LoveIconOn             = _float3(64.f, 28.f, 1.f);
    m_vScale_LoveIconOff            = _float3(64.f, 28.f, 1.f);
    m_vPosition_LoveIconOn          = _float4(-553.f, -316.f, 0.4f, 1.f);
    m_vPosition_LoveIconOff         = _float4(-553.f, -316.f, 0.4f, 1.f);


    /* LoveIndex */
    m_vScale_LoveIndexOn            = _float3(7.f, 9.f, 1.f);
    m_vScale_LoveIndexOff           = _float3(7.f, 9.f, 1.f);
    m_vPosition_LoveIndexOn         = _float4(-537.f, -316.f, 0.4f, 1.f);
    m_vPosition_LoveIndexOff        = _float4(-537.f, -316.f, 0.4f, 1.f);


    /* ProfileHp */
    m_vScale_ProfileHpOn            = _float3(220.f, 7.f, 1.f);
    m_vScale_ProfileHpOff           = _float3(220.f, 7.f, 1.f);
    m_vPosition_ProfileHpOn         = _float4(-635.f, -358.f, 0.4f, 1.f);
    m_vPosition_ProfileHpOff        = _float4(-635.f, -358.f, 0.4f, 1.f);
    ...
    m_pTexture_Profile              = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/Kagero.png"));
    m_pTexture_SkillIconFrame       = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/SkillIconFrame.png"));
    m_pTexture_SkillIcon            = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/Icon_Invisable.png"));
    ...
    m_pTexture_LoveIndex            = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/6.png"));
    ...
    {
        MSG_RETURN(E_FAIL, "CUI_Menu_Profile_PartySupport2::Initialize", "Failed to Get_Component: CVIBuffer_Rect");
    }
    ...
    p3DUILayer->Iterate_Objects([&](shared_ptr<CGameObject> pObject)
        {
            ...
            if (pMenuCharacter->Get_ModelTag() == PROTOTYPE_COMPONENT_MODEL_KAGERO)
            {
...
void CUI_Menu_Profile_PartySupport2::Tick(_float fTimeDelta)
{
...
void CUI_Menu_Profile_PartySupport2::Late_Tick(_float fTimeDelta)
{
...
HRESULT CUI_Menu_Profile_PartySupport2::Render()
{
    if (true == CUI_Manager::Get_Instance()->Get_OnOffSwitch_RenderUI())
    {
        if (0 == CUI_Manager::Get_Instance()->Get_MenuIndex())
        {
            ...
            if (4 == CUI_Manager::Get_Instance()->Get_SelectMemberIndex())
            {
                ...
                CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strName,          _float2(214.f, 818.f), XMVectorSet(0.96f, 0.81f, 0.74f, 1.0f), 0.47f);
                CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strLevelTag,      _float2(216.f, 854.f), XMVectorSet(0.96f, 0.81f, 0.74f, 1.0f), 0.3f);
                CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strLevelIndex,    _float2(250.f, 847.f), XMVectorSet(0.96f, 0.81f, 0.74f, 1.0f), 0.53f);
                CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strHpTag,         _float2(216.f, 878.f), XMVectorSet(0.96f, 0.81f, 0.74f, 1.0f), 0.3f);
                CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strHp,            _float2(366.f, 878.f), XMVectorSet(0.96f, 0.81f, 0.74f, 1.0f), 0.3f);
                CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strHpSeperate,    _float2(396.f, 878.f), XMVectorSet(0.96f, 0.81f, 0.74f, 1.0f), 0.3f);
                CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strHpMax,         _float2(406.f, 878.f), XMVectorSet(0.96f, 0.81f, 0.74f, 1.0f), 0.3f);
                CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strPsyco,         _float2(465.f, 886.f), XMVectorSet(0.f, 0.f, 0.f, 1.0f), 0.4f);
...
HRESULT CUI_Menu_Profile_PartySupport2::Ready_Components()
{
    if (FAILED(__super::Ready_Components()))
    {
        MSG_RETURN(E_FAIL, "CUI_Menu_Profile_PartySupport2::Ready_Components", "Failed to CGameObject::Ready_Components");
    }
    m_pShader = Get_Component<CShader>(COMPONENT::SHADER);
    if (nullptr == m_pShader)
    {
        MSG_RETURN(E_FAIL, "CUI_Menu_Profile_PartySupport2::Ready_Components", "Failed to Get_Component: SHADER");
    }

    return S_OK;
}

void CUI_Menu_Profile_PartySupport2::KeyWorks()
{
    if (true == CUI_Manager::Get_Instance()->Get_OnOffSwitch_RenderUI())
    {
        if (0 == CUI_Manager::Get_Instance()->Get_MenuIndex())
...
shared_ptr<CUI_Menu_Profile_PartySupport2> CUI_Menu_Profile_PartySupport2::Create(ComPtr<ID3D11Device>_pDevice, ComPtr<ID3D11DeviceContext> _pContext)
{
    shared_ptr<CUI_Menu_Profile_PartySupport2> pInstance = make_private_shared(CUI_Menu_Profile_PartySupport2, _pDevice, _pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_RETURN(nullptr, "CUI_Menu_Profile_PartySupport2::Create", "Failed to Initialize_Prototype");
    }

    return pInstance;
}

shared_ptr<CGameObject> CUI_Menu_Profile_PartySupport2::Clone(any _pPlayerEntityDesc)
{
    shared_ptr<CUI_Menu_Profile_PartySupport2> pInstance = make_private_shared_copy(CUI_Menu_Profile_PartySupport2, *this);
