...
CHitCrackDecal::CHitCrackDecal(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
...
void CHitCrackDecal::Tick(_float fTimeDelta)
{
	if (m_bFetched)
	{
...
void CHitCrackDecal::Late_Tick(_float fTimeDelta)
{
	if (m_bFetched)
	{
...
HRESULT CHitCrackDecal::Fetch(any DecalDesc)
{
	...
	DECALDESC tDecalDesc = any_cast<DECALDESC>(DecalDesc);
...
shared_ptr<CHitCrackDecal> CHitCrackDecal::Create(ComPtr<ID3D11Device> pDevice, ComPtr<ID3D11DeviceContext> pContext)
{
	shared_ptr<CHitCrackDecal> pInstance = make_private_shared(CHitCrackDecal, pDevice, pContext);
