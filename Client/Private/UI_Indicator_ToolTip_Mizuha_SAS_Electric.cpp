...
#define MOVIE_MAX       275

CUI_Indicator_ToolTip_Mizuha_SAS_Electric::CUI_Indicator_ToolTip_Mizuha_SAS_Electric(ComPtr<ID3D11Device> _pDevice, ComPtr<ID3D11DeviceContext> _pContext)
	: CGameObject(_pDevice, _pContext)
{
}

HRESULT CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Initialize_Prototype()
{
...
HRESULT CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Initialize(any _aDesc)
{
...
void CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Tick(_float fTimeDelta)
{
    __super::Tick(fTimeDelta);
}

void CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Late_Tick(_float fTimeDelta)
{
...
HRESULT CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Render()
{
    if (true == m_bMovieStart)
    {
        ...
        CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strExplanation2_1,    _float2(773.f, 540.f),      XMVectorSet(255.f * m_fSeperateLineTime / 255.f, 180.f * m_fSeperateLineTime / 255.f, 180.f * m_fSeperateLineTime / 255.f, m_fMovieShaderTime), 0.5f);
        CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strExplanation2_2,    _float2(863.f, 540.f),      XMVectorSet(m_fSeperateLineTime, m_fSeperateLineTime, m_fSeperateLineTime, m_fMovieShaderTime), 0.5f);
        ...
        CGameInstance::Get_Instance()->Render_Font(TEXT("Font_ScarletStrings"), m_strExplanation6,      _float2(603.f, 710.f),      XMVectorSet(m_fSeperateLineTime, m_fSeperateLineTime, m_fSeperateLineTime, m_fMovieShaderTime), 0.5f);
...
HRESULT CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Ready_Components()
{
...
void CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Initialize_UI()
{
//=========================================================================== _float
...
//=========================================================================== Texture
    ...
    m_pTexture_Movie                    = CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Indicator/Mizuha_Tips/SAS_Electric/T_ui_TutoTips_019_01_common_f_MV_Movie_40534656.mkv_%d.png"), MOVIE_MAX, true);
...
//=========================================================================== Explanation
    m_strTitle          = L"SAS 방전";
    m_strExplanation1   = L"방전 뇌능력을 빌려 공격과 오브젝트에 전기를 둘러서";
    m_strExplanation2   = L"연속 공격으로 적을 ";
    m_strExplanation2_1 = L"감전 상태";
    m_strExplanation2_2 = L"로 만들 수 있게 된다.";
    m_strExplanation3   = L"침수 상태인 적에게 적극적으로 발동할 것을 추천한다.";
    m_strExplanation4   = L"또한, 무기 콤보로 스파크가 발생해";
    m_strExplanation5   = L"공중에 있는 적에게도 데미지를 주기 쉬워진다.";
    m_strExplanation6   = L"시덴과의 유대가 깊어질수록 추가 효과가 늘어난다.";

    m_strEnter          = L"닫기";

}

void CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Tick_UI(_float fTimeDelta)
{
...
void CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Movie_System(_float fTimeDelta)
{
...
void CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Sound(_float fTimeDelta)
{
    if (true == m_bMovieStart && false == m_bToolTip_End)
    {
        if (0 == m_iSoundIndex)
...
void CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Movie_Start()
{
...
void CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Movie_End(_float fTimeDelta)
{
...
shared_ptr<CUI_Indicator_ToolTip_Mizuha_SAS_Electric> CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Create(ComPtr<ID3D11Device> _pDevice, ComPtr<ID3D11DeviceContext> _pContext)
{
    shared_ptr<CUI_Indicator_ToolTip_Mizuha_SAS_Electric> pInstance = make_private_shared(CUI_Indicator_ToolTip_Mizuha_SAS_Electric, _pDevice, _pContext);

    if (FAILED(pInstance->Initialize_Prototype()))
    {
        MSG_RETURN(nullptr, "CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Create", "Failed to Initialize_Prototype");
    }

    return pInstance;
}

shared_ptr<CGameObject> CUI_Indicator_ToolTip_Mizuha_SAS_Electric::Clone(any aDesc)
{
    shared_ptr<CUI_Indicator_ToolTip_Mizuha_SAS_Electric> pInstance = make_private_shared_copy(CUI_Indicator_ToolTip_Mizuha_SAS_Electric, *this);
