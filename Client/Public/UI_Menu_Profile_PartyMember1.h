...
class CUI_Menu_Profile_PartyMember1 final : public CGameObject
{
private:
	explicit CUI_Menu_Profile_PartyMember1(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CUI_Menu_Profile_PartyMember1() DEFAULT;
...
public:
	static shared_ptr<CUI_Menu_Profile_PartyMember1>	Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
