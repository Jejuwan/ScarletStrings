...
class CUI_Indicator_ToolTip_Mizuha_SAS_Replication final : public CGameObject
{
private:
	explicit CUI_Indicator_ToolTip_Mizuha_SAS_Replication(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CUI_Indicator_ToolTip_Mizuha_SAS_Replication()DEFAULT;
...
public:
	static shared_ptr<CUI_Indicator_ToolTip_Mizuha_SAS_Replication>			Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
