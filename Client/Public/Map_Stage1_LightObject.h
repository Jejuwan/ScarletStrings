...
class CMap_Stage1_LightObject : public CGameObject
{
private:
	explicit CMap_Stage1_LightObject(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Stage1_LightObject(const CMap_Stage1_LightObject&);
	virtual ~CMap_Stage1_LightObject() DEFAULT;
...
public:
	static shared_ptr<CMap_Stage1_LightObject>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
