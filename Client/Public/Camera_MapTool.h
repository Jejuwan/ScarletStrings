...
class CCamera_MapTool final : public CCinematicCamera
{
public:
...
private:
	explicit CCamera_MapTool(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
...
public:
	static shared_ptr<CCamera_MapTool>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
