...
class CMap_Suoh_Building : public CGameObject
{
private:
	explicit CMap_Suoh_Building(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Suoh_Building(const CMap_Suoh_Building&);
	virtual ~CMap_Suoh_Building() DEFAULT;
...
public:
	static shared_ptr<CMap_Suoh_Building>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
