...
class CScene_Suoh final : public CScene
{
private:
	explicit CScene_Suoh(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CScene_Suoh() DEFAULT;
...
private:
	...
	shared_ptr<CObjectLayer> m_pNPCLayer;
...
public:
	static shared_ptr<CScene_Suoh>	Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
};
