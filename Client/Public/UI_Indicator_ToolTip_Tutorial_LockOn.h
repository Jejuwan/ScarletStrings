...
class CUI_Indicator_ToolTip_Tutorial_LockOn final : public CGameObject
{
private:
	explicit CUI_Indicator_ToolTip_Tutorial_LockOn(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CUI_Indicator_ToolTip_Tutorial_LockOn() DEFAULT;
...
private:
	...
	// Add
	shared_ptr<CTransform>									m_pKey_Q;
...
private:
	...
	// Add
	shared_ptr<CTexture>									m_pTexture_Key_Q;
...
public:
	static shared_ptr<CUI_Indicator_ToolTip_Tutorial_LockOn>Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
