...
class CMap_Shopkeeper : public CGameObject
{
private:
	explicit CMap_Shopkeeper(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Shopkeeper(const CMap_Shopkeeper&);
	virtual ~CMap_Shopkeeper() DEFAULT;
...
public:
	static shared_ptr<CMap_Shopkeeper>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
