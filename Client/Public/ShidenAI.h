...
class CShidenAI final : public CTeammateAI
{
private:
	CShidenAI() DEFAULT;
	virtual ~CShidenAI() DEFAULT;
...
private:
	...
	_float4											m_vNextPosition;

	_float											m_fBattleChaseDistanceThreshold = { 2.f };
	_float											m_fChaseRadius = { 3.f };

	_float											m_fChaseDelay = { 0.f };
	_float											m_fChaseInterval = { 4.f };

	_float											m_fAttackDelay = { 0.f };
	_float											m_fAttackInterval = { 15.f };

	/*==================================== Attack Dodge ====================================*/
	_bool											m_bDodgeStartEnded = { false };
...
private:
	shared_ptr<CStateTemplate<CShidenAI>>			m_pState_Battle_Idle;
	shared_ptr<CStateTemplate<CShidenAI>>			m_pState_Battle_Chase;
	shared_ptr<CStateTemplate<CShidenAI>>			m_pState_Attack_Dodge;
	shared_ptr<CStateTemplate<CShidenAI>>			m_pState_Attack;
	shared_ptr<CStateTemplate<CShidenAI>>			m_pState_Attack_Escape;
