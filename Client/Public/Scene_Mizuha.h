...
class CScene_Mizuha final : public CScene
{
private:
	explicit CScene_Mizuha(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CScene_Mizuha() DEFAULT;
...
private:
	...
	shared_ptr<class CGameObject>	m_pDispenPerry;
...
public:
	static shared_ptr<CScene_Mizuha>	Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
public:
	shared_ptr<class CGameObject>	Get_DispenPerry() { return m_pDispenPerry; }
};
