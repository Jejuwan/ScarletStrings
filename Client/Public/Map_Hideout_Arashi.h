...
class CMap_Hideout_Arashi : public CGameObject
{
private:
	explicit CMap_Hideout_Arashi(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Hideout_Arashi(const CMap_Hideout_Arashi&);
	virtual ~CMap_Hideout_Arashi() DEFAULT;
...
public:
	static shared_ptr<CMap_Hideout_Arashi>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
