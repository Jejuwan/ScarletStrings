...
class CMap_Suoh_Signboard : public CGameObject
{
private:
	explicit CMap_Suoh_Signboard(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Suoh_Signboard(const CMap_Suoh_Signboard&);
	virtual ~CMap_Suoh_Signboard() DEFAULT;
...
public:
	static shared_ptr<CMap_Suoh_Signboard>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
