...
inline HRESULT CLoader::Load_SuohScene()
{
...
#pragma region GameObject
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_PLAYER,
		CPlayer::Create(m_pDevice, m_pContext))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_PLAYER");
	}

	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_PSYCHOKINESIS,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_PLAYER_WEAPON,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_PLAYER_TENTACLE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_CAMERA_PLAYER,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_CHARACTER_ARASHI,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_CHARACTER_SHIDEN,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_CHARACTER_KYOKA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_CHARACTER_KAGERO,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CHARACTER,
...
#pragma region MODEL
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_KASANE,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_ARASHI,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SHIDEN,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_KYOKA,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_KAGERO,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_PLAYER,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_PLAYER_WEAPON,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_PLAYER_TENTACLE,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_MONSTER_DISPENPERRY,
...
#ifdef _DEBUG
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, TEXT("TestModel"),
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, TEXT("TestModel"),
...
#pragma region Prototype Model_NeonLine
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONCORNERA,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONCORNERB,
		CModel::Create(m_pDevice, m_pContext, MODEL::NONANIM, TEXT("Bin/Resources/Map/Neon/NeonCornerB.mdl")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_NEONCORNERA");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONCORNERC,
		CModel::Create(m_pDevice, m_pContext, MODEL::NONANIM, TEXT("Bin/Resources/Map/Neon/NeonCornerC.mdl")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_NEONCORNERA");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONCORNERD,
		CModel::Create(m_pDevice, m_pContext, MODEL::NONANIM, TEXT("Bin/Resources/Map/Neon/NeonCornerD.mdl")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_NEONCORNERA");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONCRASHA,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONCRASHB,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONLINEA,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONLINEB,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONROLLA,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONSWAYA,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONSWAYB,
		CModel::Create(m_pDevice, m_pContext, MODEL::NONANIM, TEXT("Bin/Resources/Map/Neon/NeonSwayB.mdl")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_NEONSWAYA");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_NEONSWAYC,
...
#pragma region Prototype Model_SuohStatic
	...
	if (FAILED(pModelRenderer->Create_Model_Instance(PROTOTYPE_COMPONENT_MODEL_MAITREYATRII,
		CModel::Create(m_pDevice, m_pContext, MODEL::NONANIM, TEXT("Bin/Resources/Map/Suoh/mdl/MaitreyaTrii.mdl")), 1)))
	{
...
#pragma region Prototype Model_Suoh_Dynamic
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SUOH_CARA, pCarA)))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SUOH_CARB, pCarB)))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_SUOH_CARA");
	}
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SUOH_CARC, pCarC)))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_SUOH_CARA");
	}
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SUOH_CARD, pCarD)))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_SUOH_CARA");
	}
...
#pragma region Prototype Model_Suoh_NPC
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SUOH_NPC_CHILD,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SUOH_NPC_MAN,
		CModel::Create(m_pDevice, m_pContext, MODEL::ANIM, TEXT("Bin/Resources/Map/Suoh/mdl/Suoh_NPC_Man1.mdl")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_SuohScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_SUOH_NPC_MAN");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SUOH_NPC_WOMAN,
		CModel::Create(m_pDevice, m_pContext, MODEL::ANIM, TEXT("Bin/Resources/Map/Suoh/mdl/Suoh_NPC_Woman1.mdl")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_SuohScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_SUOH_NPC_WOMAN");
	}
#pragma endregion

	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_COMMON_ITEM,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_SHOPKEEPER,
		CModel::Create(m_pDevice, m_pContext, MODEL::ANIM, TEXT("Bin/Resources/Map/Common/mdl/Shopkeeper.mdl")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_MODEL_SHOPKEEPER");
	}



#pragma region UI
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_HP_BACKGROUND,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_HP,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_PSYCO_WAVE,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_ITEMBOX,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_ITEMTAG,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_ITEMHUD_R,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_ITEMHUD_B,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_SKILLSLOT,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_SKILLCHANGER,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_CHANGERICON,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_SKILLCHANGERKEY_L,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_SKILLCHANGERKEY_R,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_SKILLCHANGER_LIGHT,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_DRIVE_BACKGROUND,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_DRIVE_GAUGE,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_DRIVE_SIDEGAUGE,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_BLACK_BACKGROUND,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_BACKGROUND,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/UI_MenuBackground.dds")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_SUOHScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_BACKGROUND");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_FILLTER,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_CATEGORY_PARTY,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_CATEGORY_ITEM,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_CATEGORY_EQUIP,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/CategoryOff.dds")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_CATEGORY_BRAINMAP,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/CategoryOff.dds")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_CATEGORY_SAS,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/CategoryOff.dds")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_CATEGORY_STORY,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/CategoryOff.dds")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_CATEGORY_LIBRARY,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/CategoryOff.dds")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_CATEGORY_OPTION,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/CategoryOff.dds")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_ARROW_L,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_ARROW_R,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/Arrow_R.png")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_SUOHScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_ARROW_L");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_BUTTON,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_PROFILE_PARTYLEADER,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_PROFILE_PARTYMEMBER1,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_PROFILE_PARTYMEMBER2,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/ProfileOff.png")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_PROFILE_PARTYSUPPORT1,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/ProfileOff.png")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_PROFILE_PARTYSUPPORT2,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/ProfileOff.png")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_SEPERATE_LINE,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_PROFILE_FILLTER,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/MenuFillter.png")))))
	{
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_PROFILE_ID_CARD,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Menu/MenuFillter.png")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_SUOHScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_PROFILE_FILLTER");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_MENU_FADE_FILLTER,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_MODEL_MENU,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_INDICATOR_OBJECTATTACK,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_INDICATOR_SPCOBJECTATTACK,
		CTexture::Create(m_pDevice, m_pContext, TEXT("Bin/Resources/Texture/UI/Indicator/Indicator_G.png")))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_SUOHScene", "Failed to Add_Component_Prototype: PROTOTYPE_COMPONENT_TEXTURE_UI_INDICATOR_SPCOBJECTATTACK");
	}
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_INDICATOR_TOOLTIP_PMCC,
	...
	if (FAILED(pGameInstance->Add_Component_Prototype(SCENE::SUOH, PROTOTYPE_COMPONENT_TEXTURE_UI_NAME_TOWN,
...
#pragma region Prototype GameObject
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_CAMERA_MAIN,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_SKYCUBE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_CLOUD,
...
#pragma region Prototype GameObject_Map_NeonLine
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONCORNERA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONCORNERB,
		CMap_NeonLine::Create(m_pDevice, m_pContext, 1))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_SPOTLIGHTA");
	}

	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONCORNERC,
		CMap_NeonLine::Create(m_pDevice, m_pContext, 2))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_SPOTLIGHTA");
	}

	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONCORNERD,
		CMap_NeonLine::Create(m_pDevice, m_pContext, 3))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_SPOTLIGHTA");
	}

	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONCRASHA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONCRASHB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONLINEA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONLINEB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONROLLA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONSWAYA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONSWAYB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_NEONSWAYC,
...
#pragma region Prototype GameObject_Map_SuohRoad
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_MINIMAP,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_GROUND_A,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_PEDESTRIANBRIDGEA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_DODAI,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_TILE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_ROADB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_ROADC,
...
#pragma region Prototype GameObject_Map_SuohStatic
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_WALLB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_WALLC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_WALLD,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_SHUTTERBASE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_ROADA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_SHUTTERA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_FLOWERPOT,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_KEIJIBAN,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SEKIHI,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_OMIKUJIB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_ARCHA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUMERAGI_KAIDANA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_RUBBLEA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_PLANTSA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_TREEA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_SUMERAGI_TOUROU,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_MAITREYATRII,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_CAMERAA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_CAMERAD,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_HYDRANTA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TELEPHONEBOXA,
...
#pragma region Prototype GameObject_Map_SuohBuilding
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_ACADEMYA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_TOWER,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BRIDGE,
		CMap_Suoh_Building::Create(m_pDevice, m_pContext, 2))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_SG_SHUTTERBASE");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_BUILDINGA,
		CMap_Suoh_Building::Create(m_pDevice, m_pContext, 3))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_SG_SHUTTERBASE");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_BUILDINGB,
		CMap_Suoh_Building::Create(m_pDevice, m_pContext, 4))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_SG_SHUTTERBASE");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SG_BUILDINGC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_A_BUILDINGA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_A_BUILDINGB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_B_BUILDINGA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_C_BUILDINGA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_C_BUILDINGB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_C_BUILDINGC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_C_BUILDINGD,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_D_BUILDINGA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_D_BUILDINGB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_D_BUILDINGC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_D_BUILDINGD,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_E_BUILDINGA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_E_BUILDINGB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_E_BUILDINGC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_E_BUILDINGD,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_E_BUILDINGE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_E_BUILDINGF,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_F_BUILDINGA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_F_BUILDINGB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_G_BUILDINGA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_G_BUILDINGB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_G_BUILDINGC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_CAFEBUILDING,
...
#pragma endregion
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_COMMON_BASEWALL,
...
#pragma region Prototype GameObject_Map_Suoh_Signboard
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_A0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_A1,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_A2,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_A3,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_C0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_D0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_G0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_I0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_I1,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_I2,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_I3,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_J0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_GUIDEA_A,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_GUIDEA_B,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_GUIDEA_C,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_GUIDEB_A,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_GUIDEC_A,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_GUIDEC_B,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_GUIDEC_C,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_GUIDEC_D,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SIGNA_A,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SIGNA_B,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SIGNA_C,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SIGNB_A,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SIGND_D,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SIGNE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARDX_A,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARDX_B,
		CMap_Suoh_Signboard::Create(m_pDevice, m_pContext, 27))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARDX_A");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARDX_C,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARDX_D,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARDX_E,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARDX_F,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARDX_G,
...
#pragma region Prototype GameObject_Map_Suoh_ETC
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BICYCLEA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BICYCLEB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BICYCLEC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SCOOTERA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SCOOTERB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_SHOPBOX,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_B0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_B1,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_B2,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_B3,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_F0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_G1,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_G2,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_H0,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_BILLBOARD_H1,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_BOXA,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_BOXB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_BOXC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_BOXD,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_CARRIERA,
		CMap_Suoh_ETC::Create(m_pDevice, m_pContext, 19))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_TOWN_BOXD");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_CARRIERB,
		CMap_Suoh_ETC::Create(m_pDevice, m_pContext, 20))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_TOWN_BOXD");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_TOWN_CARRIERC,
...
#pragma region Prototype GameObject_Map_Suoh_Dynamic
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_CARA,
		CMap_Suoh_Dynamic::Create(m_pDevice, m_pContext, 0))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_TOWN_BOXD");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_CARB,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_CARC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_CARD,
...
#pragma region Prototype GameObject_Map_Suoh_NPC
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_NPC_CHILD,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_NPC_PART,
		CNPC_Part::Create(m_pDevice, m_pContext, 0))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_SuohScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_SUOH_NPC_CHILD");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_NPC_MAN,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SUOH_NPC_WOMAN,
...
#pragma endregion
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_COMMON_ITEM,
		CMap_Item::Create(m_pDevice, m_pContext))))
	{
		MSG_RETURN(E_FAIL, "CLoader::Load_TestScene", "Failed to Add_Object_Prototype: PROTOTYPE_GAMEOBJECT_MAP_COMMON_BASEWALL");
	}
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_MAP_SHOPKEEPER,
...
#pragma region UI
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_HPBACKGROUND,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_HP,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_PSYCOWAVE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_ITEMBOX,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_ITEMTAG,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_ITEMHUD_L,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_ITEMHUD_R,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_ITEMHUD_B,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SKILLSLOT,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SKILLCHANGER,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_CHANGERICON,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SKILLCHANGERKEY_L,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SKILLCHANGERKEY_R,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SKILLCHANGER_LIGHT,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_DRIVE_BACKGROUND,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_DRIVE_GAUGE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_DRIVE_SIDEGAUGE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_BLACK_BACKGROUND,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_BACKGROUND,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_FILLTER,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CATEGORY_PARTY,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CATEGORY_ITEM,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CATEGORY_EQUIP,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CATEGORY_BRAINMAP,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CATEGORY_SAS,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CATEGORY_STORY,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CATEGORY_LIBRARY,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_CATEGORY_OPTION,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_ARROW_L,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_ARROW_R,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_BUTTON,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_PROFILE_PARTYLEADER,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_PROFILE_PARTYMEMBER1,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_PROFILE_PARTYMEMBER2,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_PROFILE_PARTYSUPPORT1,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_PROFILE_PARTYSUPPORT2,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_SEPERATE_LINE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_PROFILE_FILLTER,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_PROFILE_ID_CARD,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MENU_FADE_FILLTER,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_INDICATOR_OBJECTATTACK,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_INDICATOR_SPCOBJECTATTACK,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_MODEL_MENU,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_NAME_TOWN,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_INDICATOR_TOOLTIP_PMCC,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SHOP,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SHOP_MENU,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SHOP_FADE,
	...
	if (FAILED(pGameInstance->Add_Object_Prototype(SCENE::SUOH, PROTOTYPE_GAMEOBJECT_UI_SHOP_INFO,
