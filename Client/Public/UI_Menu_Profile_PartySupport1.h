...
class CUI_Menu_Profile_PartySupport1 final : public CGameObject
{
private:
	explicit CUI_Menu_Profile_PartySupport1(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CUI_Menu_Profile_PartySupport1() DEFAULT;
...
private:
	...
	shared_ptr<CTransform>								m_pMEMBER;
	...
	shared_ptr<CTexture>								m_pTexture_MEMBER;
...
private:
	...
	// LEADER On / Off
	_float3												m_vScale_MEMBEROn;
	_float3												m_vScale_MEMBEROff;
	_float4												m_vPosition_MEMBEROn;
	_float4												m_vPosition_MEMBEROff;
...
public:
	static shared_ptr<CUI_Menu_Profile_PartySupport1>	Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
