...
class CMap_Suoh_Road : public CGameObject
{
private:
	explicit CMap_Suoh_Road(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Suoh_Road(const CMap_Suoh_Road&);
	virtual ~CMap_Suoh_Road() DEFAULT;
...
public:
	static shared_ptr<CMap_Suoh_Road>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
