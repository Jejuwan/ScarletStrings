...
class CUI_Menu_Profile_PartyMember2 final : public CGameObject
{
private:
	explicit CUI_Menu_Profile_PartyMember2(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CUI_Menu_Profile_PartyMember2() DEFAULT;
...
public:
	static shared_ptr<CUI_Menu_Profile_PartyMember2>	Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
