...
class CMap_Wall : public CGameObject
{
private:
	explicit CMap_Wall(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Wall(const CMap_Wall&);
	virtual ~CMap_Wall() DEFAULT;
...
public:
	static shared_ptr<CMap_Wall>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
