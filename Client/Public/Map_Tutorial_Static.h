...
class CMap_Tutorial_Static : public CGameObject
{
private:
	explicit CMap_Tutorial_Static(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Tutorial_Static(const CMap_Tutorial_Static&);
	virtual ~CMap_Tutorial_Static() DEFAULT;
...
public:
	static shared_ptr<CMap_Tutorial_Static>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
