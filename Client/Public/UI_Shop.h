...
class CUI_Shop final : public CGameObject
{
private:
	explicit CUI_Shop(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
...
public:
	static shared_ptr<CUI_Shop>	Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
