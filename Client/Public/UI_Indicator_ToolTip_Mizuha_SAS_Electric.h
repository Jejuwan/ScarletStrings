...
class CUI_Indicator_ToolTip_Mizuha_SAS_Electric final : public CGameObject
{
private:
	explicit CUI_Indicator_ToolTip_Mizuha_SAS_Electric(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CUI_Indicator_ToolTip_Mizuha_SAS_Electric() DEFAULT;
...
public:
	static shared_ptr<CUI_Indicator_ToolTip_Mizuha_SAS_Electric>	Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
