...
class CMap_NeonLine : public CGameObject
{
private:
	explicit CMap_NeonLine(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_NeonLine(const CMap_NeonLine&);
	virtual ~CMap_NeonLine() DEFAULT;
...
public:
	static shared_ptr<CMap_NeonLine>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
