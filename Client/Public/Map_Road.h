...
class CMap_Road : public CGameObject
{
private:
	explicit CMap_Road(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Road(const CMap_Road&);
	virtual ~CMap_Road() DEFAULT;
...
public:
	static shared_ptr<CMap_Road>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
