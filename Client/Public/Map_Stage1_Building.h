...
class CMap_Stage1_Building : public CGameObject
{
private:
	explicit CMap_Stage1_Building(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	explicit CMap_Stage1_Building(const CMap_Stage1_Building&);
	virtual ~CMap_Stage1_Building() DEFAULT;
...
public:
	static shared_ptr<CMap_Stage1_Building>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>, _int iIndex);
