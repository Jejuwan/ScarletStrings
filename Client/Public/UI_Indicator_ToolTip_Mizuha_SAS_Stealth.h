...
class CUI_Indicator_ToolTip_Mizuha_SAS_Stealth final : public CGameObject
{
private:
	explicit CUI_Indicator_ToolTip_Mizuha_SAS_Stealth(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
	virtual ~CUI_Indicator_ToolTip_Mizuha_SAS_Stealth() DEFAULT;
...
private:
	...
	wstring															m_strExplanation4_1;
	wstring															m_strExplanation4_2;
	wstring															m_strExplanation5;
	wstring															m_strEnter;

public:
	static shared_ptr<CUI_Indicator_ToolTip_Mizuha_SAS_Stealth>		Create(ComPtr<ID3D11Device>, ComPtr<ID3D11DeviceContext>);
